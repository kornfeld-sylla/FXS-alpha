...
hold off
[p,h,stats] = ranksum(FX.st_aperiodic(:,1),WT.st_aperiodic(:,1), 'Alpha', 0.05)
...
hold off
[pp,hh,statss] = ranksum(FX.st_exponent,WT.st_exponent, 'Alpha', 0.05)
...
hold off
[p,h,stats] = ranksum(FX.st_first_peak(:,1),WT.st_first_peak(:,1))
...
[pp,hh,stats] = ranksum(FX.st_first_peak(:,2),WT.st_first_peak(:,2))
...
[p,h,stats] = ranksum(FX.st_second_peak(:,1),WT.st_second_peak(:,1))
...
hold off
[pp,hh,statss] = ranksum(FX.st_second_peak(:,2),WT.st_second_peak(:,2))
